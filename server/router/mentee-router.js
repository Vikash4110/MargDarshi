...
// router.post("/blogs/like", menteeMiddleware, blogControllers.likeBlog);
// router.post("/blogs/comment", menteeMiddleware, blogControllers.commentBlog);
// router.post("/blogs/share", menteeMiddleware, blogControllers.shareBlog);
