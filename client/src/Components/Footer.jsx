        ...
        <div className="grid grid-cols-1 gap-y-12 sm:grid-cols-2 lg:grid-cols-4 gap-x-8">
          ...
          >
            ...
            <ul className="flex items-center space-x-4">
              {[
                { icon: 'twitter', path: 'M19.633 7.997...' },
                { icon: 'facebook', path: 'M13.397 20.997...' },
                { icon: 'instagram', path: 'M11.999 7.377...' },
                { icon: 'github', path: 'M12.026 2...' },
              ].map((social, index) => (
                <motion.li
                  key={index}
                ...
                >
                  <a
                    href="#"
                    className="flex items-center justify-center w-10 h-10 bg-gray-700 rounded-full transition-all duration-300 hover:bg-teal-500 focus:bg-teal-500"
                  >
                    <svg
                      className="w-5 h-5"
            ...
            <ul className="mt-6 space-y-4">
              {['About', 'Mentors', 'Contact'].map((item, index) => (
                ...
                >
                  <a
                    href="#"
                    className="text-base text-gray-100 transition-all duration-300 hover:text-teal-200 hover:underline focus:underline"
                  >
                    {item}
                  </a>
                </motion.li>
