...
const stats = [
  {
    icon: <FaUserTie className="w-12 h-12 text-[#127C71]" />,
    title: "120+ Mentors",
    description: "Experts from top global companies guiding your journey.",
  },
  {
    icon: <FaCalendarCheck className="w-12 h-12 text-[#127C71]" />,
    title: "5,000+ Sessions",
    description: "Successfully conducted mentorship engagements.",
  },
  {
    icon: <FaChartLine className="w-12 h-12 text-[#127C71]" />,
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <span className="relative text-gray-800">
            Our <span className="text-[#127C71] font-extrabold">Achievements</span>
