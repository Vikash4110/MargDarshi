...
const HomeHero = () => {
  ...
  return (
    <section className="bg-gradient-to-br from-gray-50 to-teal-50 py-12 md:py-16 lg:py-20 overflow-hidden">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          {/* Text Section */}
          <motion.div
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight mb-6">
              <span className="text-gray-800 block">
                Shape Your{' '}
                <span className="text-[#127C71] relative inline-block">
                  Future
                  <svg
              ...
              <span className="text-gray-800 block mt-4">
                with Expert{' '}
                <span className="text-[#127C71]">Guidance</span>
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
              <motion.div variants={buttonVariants} whileHover="hover" whileTap="tap">
                <Link
                  to="/mentee-register"
                  className="bg-gradient-to-r from-[#127C71] to-teal-500 text-white font-semibold py-3 px-8 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center"
                >
                  Join as Mentee
