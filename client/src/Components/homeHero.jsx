          ...
          <div className="flex-1 md:w-7/12 text-center md:text-left">
            <div className="flex flex-col justify-center h-full space-y-6 md:space-y-10">
              ...
              <div className="flex flex-col md:flex-row justify-center md:justify-start space-y-2 md:space-y-0 md:space-x-4">
                <Link to="/mentee-register" className="bg-[#127C71] text-white font-semibold py-2 px-4 rounded-full hover:bg-[#0f6f5c] transition">
                  Join as Mentee
                </Link>
                <Link to="/mentor-register" className="border-2 border-[#127C71] text-[#127C71] font-semibold py-2 px-4 rounded-full hover:bg-[#127C71] hover:text-white transition">
                  Become a Mentor
                </Link>
              </div>
            </div>
