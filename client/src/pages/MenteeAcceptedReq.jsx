// // src/pages/MenteeAcceptedReq.jsx
// import React, { useEffect, useState, useRef } from "react";
// import { motion, AnimatePresence } from "framer-motion";
// import { useAuth } from "../store/auth";
// import { toast } from "react-toastify";
// import "react-toastify/dist/ReactToastify.css";
// import { FaEnvelope, FaBriefcase, FaIndustry, FaUser, FaTimes, FaPaperPlane, FaCheck, FaCheckDouble, FaVideo } from "react-icons/fa";
...
//   useEffect(() => {
//     if (!isVideoCallOpen || !selectedMentor || !user) return;

//     const startVideoCall = async () => {
//       const channelName = `mentor-${selectedMentor._id}-mentee-${user._id}`;
...
//     startVideoCall();
//   }, [isVideoCallOpen, selectedMentor, user]);
...
//                   className="py-3 rounded-lg font-semibold text-white shadow-md transition duration-300 bg-gradient-to-r from-teal-500 to-teal-700 hover:from-teal-600 hover:to-teal-800 flex items-center justify-center"
//                   whileHover={{ scale: 1.05 }}
//                   whileTap={{ scale: 0.95 }}
//                 >
...
import { toast } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";
import { FaEnvelope, FaCalendar, FaIndustry, FaUser, FaTimes, FaPaperPlane, FaCheck, FaCheckDouble, FaVideo ,FaBriefcase} from "react-icons/fa";
import io from "socket.io-client";
import Img from "../assets/profile2.jpg";
import { ZegoUIKitPrebuilt } from "@zegocloud/zego-uikit-prebuilt";
