...
//           ...comment,
//           userId: {
//             _id: comment.userId?._id || comment.userId, // Handle both cases (ID or populated object)
...
//                 <p className="text-gray-700 mb-4 line-clamp-2 leading-relaxed">{blog.content}</p>
