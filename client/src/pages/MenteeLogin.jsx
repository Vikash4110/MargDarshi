...
import Img from "../assets/menteeimg.svg"; // Update the path if necessary
        ...
        >
          ...
          >
            <p className="text-sm text-gray-600">
              New Here?{" "}
              <Link to="/mentee-register" className="text-[#0f6f5c] font-semibold hover:underline transition-all">
                Sign Up
              </Link>
            </p>
            <p className="text-sm text-gray-600">
