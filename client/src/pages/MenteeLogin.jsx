      ...
      >
        ...
        <div className="flex flex-col items-center mt-4 space-y-2">
          <p className="text-sm text-gray-600">
            New Here?{" "}
            <Link to="/mentee-register" className="text-gray-800 font-semibold hover:underline">
              Sign Up
            </Link>
          </p>
          <p className="text-sm text-gray-600">
            Forgot Password?{" "}
            <Link to="/forgot-password" className="text-gray-800 font-semibold hover:underline">
              Reset Here
            </Link>
          </p>
        </div>
